...
public class Main {
    ...
    public static void main(String[] args) {
        // Mengisi stok buku
        bookList.add(0, new Book("kj12-mn64-43fd", "cinderela", 2, "renita"));
        bookList.add(1, new Book("98hf-yr23-6j23", "Kancil", 7, "asa"));
        bookList.add(2, new Book("765g-lkku-sda3", "Zaman Dahulu", 12, "bita"));
